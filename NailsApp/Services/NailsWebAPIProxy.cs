...
namespace NailsApp.Services
{
    public class NailsWebAPIProxy
    {
        ...
        */
        ...
        {
            return $"{NailsWebAPIProxy.ImageBaseAddress}profileImages/default.jpg";
        }
        ...
        public async Task<List<Post>> GetPosts()
        {
            ...
            //Set URI to the specific function API
            string url = $"{this.baseUrl}GetPosts";
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    List<Post>? result = JsonSerializer.Deserialize<List<Post>>(resContent, options);
                    return result;
                }
                else
                {
